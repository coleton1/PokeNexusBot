...
# Load images
image_paths = ['fight.png', 'battle.png', 'hyper.png', 'bug.png','haunter.png','fish.png']  # Images to be loaded
...
def gui():
    ...
    fishing_mode_switch = ctk.CTkSwitch(root, text="Fishing(EXTREMLY BUGGED)", font=("Arial", 12, "bold"), fg_color="#FF0000", command=fishing_mode_on_off)
    fishing_mode_switch.pack(pady=5)
    fishing_mode_label = ctk.CTkLabel(root, text="Off ", font=("Arial", 14, "bold"))
    fishing_mode_label.place(y=177, x=118) #PUT ON 140 WHEN FIXXED 
